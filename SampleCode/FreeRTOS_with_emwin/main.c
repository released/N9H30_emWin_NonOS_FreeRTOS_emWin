...
#define setDEFAULT_PRIORITY		( tskIDLE_PRIORITY )
#define setLOW_PRIORITY			( setDEFAULT_PRIORITY + 1 )
#define setMEDIUM_PRIORITY 		( setLOW_PRIORITY + 1 )
#define setHIGH_PRIORITY 			( setMEDIUM_PRIORITY + 1 )
