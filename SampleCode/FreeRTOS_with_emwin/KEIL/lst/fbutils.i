...
unsigned int xres=800, yres=480;
...
void put_cross(int x, int y, unsigned colidx)
{
    ...
    line (x + 9, y - 6, x + 9, y - 9, colidx + 1);
    line (x + 8, y - 9, x + 6, y - 9, colidx + 1);
#line 84 "..\\tslib\\fbutils.c"
}
#line 113 "..\\tslib\\fbutils.c"
void setcolor(unsigned colidx, unsigned value)
{
    unsigned res;
...
#line 127 "..\\tslib\\fbutils.c"

    switch (bytes_per_pixel)
    {
    default:
    case 1:
#line 144 "..\\tslib\\fbutils.c"
        break;
    case 2:
#line 154 "..\\tslib\\fbutils.c"
    case 4:
        res = value;
    }
...
void pixel (int x, int y, unsigned colidx)
{
    ...
    xormode = colidx & 0x80000000;
    colidx &= ~0x80000000;

#line 213 "..\\tslib\\fbutils.c"
