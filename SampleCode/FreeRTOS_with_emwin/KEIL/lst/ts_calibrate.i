...
#line 24 "..\\tslib\\ts_calibrate.c"
#line 1 "..\\tslib\\testutils.h"
...
static int palette [] =
{
    ...
    (((((unsigned long)0x000000) & 0xFF000000ul) ^ 0xFF000000ul) | ((((unsigned long)0x000000) & 0x00FF0000ul) >> 16) | (((unsigned long)0x000000) & 0x0000FF00ul) | ((((unsigned long)0x000000) & 0x000000FFul) << 16)), (((((unsigned long)0x80e0ff) & 0xFF000000ul) ^ 0xFF000000ul) | ((((unsigned long)0x80e0ff) & 0x00FF0000ul) >> 16) | (((unsigned long)0x80e0ff) & 0x0000FF00ul) | ((((unsigned long)0x80e0ff) & 0x000000FFul) << 16)), (((((unsigned long)0xffffff) & 0xFF000000ul) ^ 0xFF000000ul) | ((((unsigned long)0xffffff) & 0x00FF0000ul) >> 16) | (((unsigned long)0xffffff) & 0x0000FF00ul) | ((((unsigned long)0xffffff) & 0x000000FFul) << 16)), (((((unsigned long)0xa0c0e0) & 0xFF000000ul) ^ 0xFF000000ul) | ((((unsigned long)0xa0c0e0) & 0x00FF0000ul) >> 16) | (((unsigned long)0xa0c0e0) & 0x0000FF00ul) | ((((unsigned long)0xa0c0e0) & 0x000000FFul) << 16)), (((((unsigned long)0x7F1F00) & 0xFF000000ul) ^ 0xFF000000ul) | ((((unsigned long)0x7F1F00) & 0x00FF0000ul) >> 16) | (((unsigned long)0x7F1F00) & 0x0000FF00ul) | ((((unsigned long)0x7F1F00) & 0x000000FFul) << 16)), (((((unsigned long)0x20201F) & 0xFF000000ul) ^ 0xFF000000ul) | ((((unsigned long)0x20201F) & 0x00FF0000ul) >> 16) | (((unsigned long)0x20201F) & 0x0000FF00ul) | ((((unsigned long)0x20201F) & 0x000000FFul) << 16)), (((((unsigned long)0x5F3F1F) & 0xFF000000ul) ^ 0xFF000000ul) | ((((unsigned long)0x5F3F1F) & 0x00FF0000ul) >> 16) | (((unsigned long)0x5F3F1F) & 0x0000FF00ul) | ((((unsigned long)0x5F3F1F) & 0x000000FFul) << 16))
};
...
static void get_sample (calibration *cal,int index, int x, int y, char *name)
{
    ...
    if (last_x != -1)
    {
        ...
        int dx = ((x - last_x) << 16) / 10;
        int dy = ((y - last_y) << 16) / 10;
        int i;
        last_x <<= 16;
        last_y <<= 16;
        for (i = 0; i < 10; i++)
        {
            put_cross (last_x >> 16, last_y >> 16, 2 | 0x80000000);
...
int ts_writefile(void)
{
#line 394 "..\\tslib\\ts_calibrate.c"
    SpiFlash_NormalProgram(0x00180000, (uint8_t *)&final_cal.a[0], 32);
