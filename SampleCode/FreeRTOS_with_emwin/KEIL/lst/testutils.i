...
#line 22 "..\\tslib\\testutils.c"
#line 1 "..\\tslib\\fbutils.h"
...
static int palette [] =
{
    ...
    (((((unsigned long)0x000000) & 0xFF000000ul) ^ 0xFF000000ul) | ((((unsigned long)0x000000) & 0x00FF0000ul) >> 16) | (((unsigned long)0x000000) & 0x0000FF00ul) | ((((unsigned long)0x000000) & 0x000000FFul) << 16)), (((((unsigned long)0x80e0ff) & 0xFF000000ul) ^ 0xFF000000ul) | ((((unsigned long)0x80e0ff) & 0x00FF0000ul) >> 16) | (((unsigned long)0x80e0ff) & 0x0000FF00ul) | ((((unsigned long)0x80e0ff) & 0x000000FFul) << 16)), (((((unsigned long)0xffffff) & 0xFF000000ul) ^ 0xFF000000ul) | ((((unsigned long)0xffffff) & 0x00FF0000ul) >> 16) | (((unsigned long)0xffffff) & 0x0000FF00ul) | ((((unsigned long)0xffffff) & 0x000000FFul) << 16)), (((((unsigned long)0xa0c0e0) & 0xFF000000ul) ^ 0xFF000000ul) | ((((unsigned long)0xa0c0e0) & 0x00FF0000ul) >> 16) | (((unsigned long)0xa0c0e0) & 0x0000FF00ul) | ((((unsigned long)0xa0c0e0) & 0x000000FFul) << 16)), (((((unsigned long)0x504030) & 0xFF000000ul) ^ 0xFF000000ul) | ((((unsigned long)0x504030) & 0x00FF0000ul) >> 16) | (((unsigned long)0x504030) & 0x0000FF00ul) | ((((unsigned long)0x504030) & 0x000000FFul) << 16)), (((((unsigned long)0xc0b880) & 0xFF000000ul) ^ 0xFF000000ul) | ((((unsigned long)0xc0b880) & 0x00FF0000ul) >> 16) | (((unsigned long)0xc0b880) & 0x0000FF00ul) | ((((unsigned long)0xc0b880) & 0x000000FFul) << 16)),
    (((((unsigned long)0x7F1F00) & 0xFF000000ul) ^ 0xFF000000ul) | ((((unsigned long)0x7F1F00) & 0x00FF0000ul) >> 16) | (((unsigned long)0x7F1F00) & 0x0000FF00ul) | ((((unsigned long)0x7F1F00) & 0x000000FFul) << 16)), (((((unsigned long)0x20201F) & 0xFF000000ul) ^ 0xFF000000ul) | ((((unsigned long)0x20201F) & 0x00FF0000ul) >> 16) | (((unsigned long)0x20201F) & 0x0000FF00ul) | ((((unsigned long)0x20201F) & 0x000000FFul) << 16)), (((((unsigned long)0x5F3F1F) & 0xFF000000ul) ^ 0xFF000000ul) | ((((unsigned long)0x5F3F1F) & 0x00FF0000ul) >> 16) | (((unsigned long)0x5F3F1F) & 0x0000FF00ul) | ((((unsigned long)0x5F3F1F) & 0x000000FFul) << 16)), (((((unsigned long)0xAFBFCF) & 0xFF000000ul) ^ 0xFF000000ul) | ((((unsigned long)0xAFBFCF) & 0x00FF0000ul) >> 16) | (((unsigned long)0xAFBFCF) & 0x0000FF00ul) | ((((unsigned long)0xAFBFCF) & 0x000000FFul) << 16)), (((((unsigned long)0xF080D0) & 0xFF000000ul) ^ 0xFF000000ul) | ((((unsigned long)0xF080D0) & 0x00FF0000ul) >> 16) | (((unsigned long)0xF080D0) & 0x0000FF00ul) | ((((unsigned long)0xF080D0) & 0x000000FFul) << 16)), (((((unsigned long)0x3F477F) & 0xFF000000ul) ^ 0xFF000000ul) | ((((unsigned long)0x3F477F) & 0x00FF0000ul) >> 16) | (((unsigned long)0x3F477F) & 0x0000FF00ul) | ((((unsigned long)0x3F477F) & 0x000000FFul) << 16)),
    (((((unsigned long)0x207820) & 0xFF000000ul) ^ 0xFF000000ul) | ((((unsigned long)0x207820) & 0x00FF0000ul) >> 16) | (((unsigned long)0x207820) & 0x0000FF00ul) | ((((unsigned long)0x207820) & 0x000000FFul) << 16))
};
...
static struct ts_button buttons [3];
...
{
    int s = (button->flags & 0x00000001) ? 3 : 0;
...
int button_handle (struct ts_button *button, int x, int y, unsigned int p)
{
    ...
    if (p > 0)
    {
        if (inside)
        {
            if (!(button->flags & 0x00000001))
            {
                button->flags |= 0x00000001;
                button_draw (button);
            }
        }
        else if (button->flags & 0x00000001)
        {
            button->flags &= ~0x00000001;
            button_draw (button);
        }
