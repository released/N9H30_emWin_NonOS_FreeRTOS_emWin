#line 1 "..\\Application\\GUI_X_FreeRTOS.c"
...
#line 45 "..\\Application\\GUI_X_FreeRTOS.c"
...
#line 46 "..\\Application\\GUI_X_FreeRTOS.c"
#line 1 "..\\..\\..\\ThirdParty\\FreeRTOSV9.0.0\\FreeRTOS\\Source\\include\\semphr.h"
...
#line 78 "..\\..\\..\\ThirdParty\\FreeRTOSV9.0.0\\FreeRTOS\\Source\\include\\semphr.h"
...
#line 145 "..\\..\\..\\ThirdParty\\FreeRTOSV9.0.0\\FreeRTOS\\Source\\include\\semphr.h"
...
#line 47 "..\\Application\\GUI_X_FreeRTOS.c"
...
#line 48 "..\\Application\\GUI_X_FreeRTOS.c"
...
#line 49 "..\\Application\\GUI_X_FreeRTOS.c"
...
void GUI_X_Delay(int Period) {
  vTaskDelay(Period / ( ( TickType_t ) 1000 / ( ( TickType_t ) 1000 ) ));
}
...
void GUI_X_InitOS(void)    { _Semaphore = xQueueCreateMutex( ( ( uint8_t ) 1U ) ); }
void GUI_X_Unlock(void)    { xQueueGenericSend( ( QueueHandle_t ) ( _Semaphore ), 0, ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) ); }
void GUI_X_Lock(void)      { xQueueGenericReceive( ( QueueHandle_t ) ( _Semaphore ), 0, ( ( TickType_t ) 0xffffffffUL ), ( ( BaseType_t ) 0 ) );  }
unsigned long  GUI_X_GetTaskId(void) { return (unsigned long)xTaskGetCurrentTaskHandle(); }
