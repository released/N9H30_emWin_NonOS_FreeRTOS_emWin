...
#line 5 "..\\tslib\\TouchPanel.c"
#line 1 "..\\..\\..\\Driver\\Include\\adc.h"
...
#line 47 "..\\..\\..\\Driver\\Include\\adc.h"

 
 
 
#line 60 "..\\..\\..\\Driver\\Include\\adc.h"

#line 71 "..\\..\\..\\Driver\\Include\\adc.h"

#line 78 "..\\..\\..\\Driver\\Include\\adc.h"

 
 
 
#line 89 "..\\..\\..\\Driver\\Include\\adc.h"

 
 
 
#line 106 "..\\..\\..\\Driver\\Include\\adc.h"
...
INT32 TouchXYCallback(UINT32 status, UINT32 userData)
{
    ...
    *((volatile unsigned int *)(0xB8003000+0xC4)) = !(*((volatile unsigned int *)(0xB8003000+0xC4)));
    return 0;
}
...
int Init_TouchPanel(void)
{
    ...
    adcOpen();
    *((volatile unsigned int *)((0xB800A000+0x004))) = ((*((volatile unsigned int *)((0xB800A000+0x004))))&~(0xfful<<24))|0xfful<<24;
...
int Read_TouchPanel(int *x, int *y)
{
    ...
    if(pendown_complete!=0)
    {
        ...
        adcReadZ(&z1,&z2,1);
        if( (((*((volatile unsigned int *)((0xB800A000+0x204))))&0xfff)<=z_th) ||
                (((*((volatile unsigned int *)((0xB800A000+0x208))))&0xfff)<=z_th) ||
                (((*((volatile unsigned int *)((0xB800A000+0x20C))))&0xfff)<=z_th) ||
                (((*((volatile unsigned int *)((0xB800A000+0x210))))&0xfff)<=z_th)    )
        {
...
void TouchTask(void) {
  static unsigned short xOld;
  static unsigned short yOld;
  static unsigned char  PressedOld;
  unsigned short x, y, xDiff, yDiff;
    int sumx;
    int sumy;
  unsigned char  Pressed;


    Pressed = pendown_complete; 
